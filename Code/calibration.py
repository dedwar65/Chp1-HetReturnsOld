...
# Number of times to 'exponentially nest' when constructing assets grid
aXtraNestFac = 3
CubicBool = False  # Whether to use cubic spline interpolation
vFuncBool = False  # Whether to calculate the value function during solution

# Set simulation parameters
# Total simulated population size, with aggregate shocks, param-point model
pop_sim_agg_point = 9600
# Total simulated population size, with aggregate shocks, param-dist model
pop_sim_agg_dist = 16800
# Total simulated population size, no aggregate shocks, param-point model
pop_sim_ind_point = 10000
# Total simulated population size, no aggregate shocks, param-dist model
pop_sim_ind_dist = 14000
...
# Standard deviation of permanent aggregate shocks
PermShkAggStd = np.sqrt(0.00004)
# Standard deviation of transitory aggregate shocks
...
# Initial slope of kNextFunc (aggregate shocks model)
slope_prev = 1.0
# Initial intercept of kNextFunc (aggregate shocks model)
intercept_prev = 0.0
