...
\subfile{Chp1-titlepage}\pagebreak

% Table of contents
\ifthenelse{\boolean{TOC}}{\subfile{Chp1-contents.texinput}\pagebreak }{}
\input{Subfiles-proposal.texinput} % Paper composed of these subfiles
