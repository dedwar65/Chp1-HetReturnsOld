...
\subfile{IneqMeas-titlepage}\pagebreak

% Table of contents
\ifthenelse{\boolean{TOC}}{\subfile{IneqMeas-contents.texinput}\pagebreak }{}
\input{Subfiles-decory.texinput} % Paper composed of these subfiles

\pagebreak\appendix
\ifthenelse{\boolean{Appendix}}{\subfile{Subfiles/Appendix-decory}\pagebreak }{}
